...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetricRecord.datetime'
        db.alter_column(u'chinup_metricrecord', 'datetime', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'MetricRecord.datetime'
        db.alter_column(u'chinup_metricrecord', 'datetime', self.gf('django.db.models.fields.DateTimeField')())
